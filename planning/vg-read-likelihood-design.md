...
| `ω_i` | `--flat-mixture` | unique content | §4.3a |
...
> `--length-weight-whole-traversal` (a flag since removed, the comparison being settled), and
> one thing found later explains part of why it underperforms:
