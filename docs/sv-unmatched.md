...
(685 of them). Proximity was not the obstacle -- truvari's refdist default is 500 bp.

| reason | n | share | of which another truth SV within 500 bp |
|---|---|---|---|
| call was compared and rejected on similarity | 486 | 70.9% | 331 (68%) |
| call was matched to a different truth variant | 199 | 29.1% | 199 (100%) |
