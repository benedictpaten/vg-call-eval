...
(684 of them). Proximity was not the obstacle -- truvari's refdist default is 500 bp.

| reason | n | share | of which another truth SV within 500 bp |
|---|---|---|---|
| call was compared and rejected on similarity | 484 | 70.8% | 329 (68%) |
| call was matched to a different truth variant | 200 | 29.2% | 200 (100%) |
