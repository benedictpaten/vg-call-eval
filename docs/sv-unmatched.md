...
(752 of them). Proximity was not the obstacle -- truvari's refdist default is 500 bp.

| reason | n | share | of which another truth SV within 500 bp |
|---|---|---|---|
| call was compared and rejected on similarity | 561 | 74.6% | 362 (65%) |
| call was matched to a different truth variant | 191 | 25.4% | 191 (100%) |
